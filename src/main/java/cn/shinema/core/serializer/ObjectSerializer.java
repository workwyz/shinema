...
public class ObjectSerializer extends AbstractSerializer {
	...
	private static ObjectSerializer forStringDate;
	...
	public static synchronized ObjectSerializer forStringDateInstance() {

		if (ObjectSerializer.forStringDate == null) {
			ObjectSerializer.forStringDate = new ObjectSerializer(1);
		}

		return ObjectSerializer.forStringDate;
	}
