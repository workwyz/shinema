...
import cn.shinema.core.domain.IdentifiedDomainObject;

public abstract class AbstractProcess extends IdentifiedDomainObject implements Process {
	...
	public String toString() {
		return "AbstractProcess [id=" + id() + "allowableDuration=" + allowableDuration + ", description=" + description
				+ ", processId=" + processId + ", processCompletionType=" + processCompletionType + ", startTime="
				+ startTime + ", tenantId=" + tenantId + ", timedOutDate=" + timedOutDate + ", totalRetriesPermitted="
