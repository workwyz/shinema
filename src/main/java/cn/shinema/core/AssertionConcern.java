...
public class AssertionConcern {
	...
	protected void assertArgumentIsJson(String jsonStr, String aMessage) {
		try {
	...
	protected void assertArgumentEquals(String anString1, String anString2, String aMessage) {
		if (!anString1.equals(anString2)) {
			throw new IllegalArgumentException(aMessage);
		}
	}
	...
	protected void assertArgumentNotEmpty(List<?> aList, String aMessage) {
	...
	protected void assertArgumentNotEquals(String anString1, String anString2, String aMessage) {
		if (!anString1.equals(anString2)) {
			throw new IllegalArgumentException(aMessage);
		}
	}
